...
class WeaponTypeTest {
    ...
    void mapperParsesBluntFromV3() {
        AttackDto dto = new AttackDto(
            AttackSchemaVersions.V3, "attack.mace", "iron mace", 5, 10, 2, 2, 2, List.of(), "BLUNT", null, null, null, null
        );
    ...
    void mapperParsesPiercingFromV3() {
        AttackDto dto = new AttackDto(
            AttackSchemaVersions.V3, "attack.dagger", "dagger", 1, 5, 8, 4, 0, List.of(), "PIERCING", null, null, null, null
        );
        AttackDefinition def = mapper.toDomain(dto);
        assertEquals(WeaponType.PIERCING, def.weaponType());
    }
    ...
    void mapperParsesSlashingFromV3() {
        AttackDto dto = new AttackDto(
            AttackSchemaVersions.V3, "attack.sword", "iron sword", 3, 8, 5, 1, 1, List.of(), "SLASHING", null, null, null, null
        );
        AttackDefinition def = mapper.toDomain(dto);
        assertEquals(WeaponType.SLASHING, def.weaponType());
    }
    ...
    void mapperDefaultsToSlashingWhenWeaponTypeAbsentInV2() {
        AttackDto dto = new AttackDto(
            AttackSchemaVersions.V2, "attack.old", "old sword", 2, 6, 3, 0, 0, List.of(), null, null, null, null, null
        );
        AttackDefinition def = mapper.toDomain(dto);
        assertEquals(WeaponType.SLASHING, def.weaponType());
    }
    ...
    void mapperDefaultsToSlashingWhenWeaponTypeBlankInV3() {
        AttackDto dto = new AttackDto(
            AttackSchemaVersions.V3, "attack.blank", "blank weapon", 1, 3, 0, 0, 0, List.of(), "", null, null, null, null
        );
        AttackDefinition def = mapper.toDomain(dto);
        assertEquals(WeaponType.SLASHING, def.weaponType());
    }
    ...
    void mapperDefaultsToSlashingForUnknownWeaponType() {
        AttackDto dto = new AttackDto(
            AttackSchemaVersions.V3, "attack.weird", "weird weapon", 1, 3, 0, 0, 0, List.of(), "UNKNOWN_TYPE", null, null, null, null
        );
        AttackDefinition def = mapper.toDomain(dto);
        assertEquals(WeaponType.SLASHING, def.weaponType());
    }
