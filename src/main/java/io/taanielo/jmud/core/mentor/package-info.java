 ...
 * the mentee earns a modest flat XP bonus on top of their normal party split; the mentor gains
 * nothing mechanically, but earns recognition (a unique title on their first graduated mentee).
 *
 ...
 * domain rules for eligibility, the XP bonus, and graduation. The persisted bond itself lives on
 * {@link io.taanielo.jmud.core.player.Player}, defaulting to "no bond" for existing saves.
 */
@NullMarked
