 ...
 */
public record ExplorationQuestResult(Player player, boolean completed, boolean leveledUp, List<String> messages) {
    ...
    public static ExplorationQuestResult progress(Player player, List<String> messages) {
        return new ExplorationQuestResult(player, false, false, messages);
    }
     ...
     */
    public static ExplorationQuestResult completed(Player player, boolean leveledUp, List<String> messages) {
        return new ExplorationQuestResult(player, true, leveledUp, messages);
    }
}
